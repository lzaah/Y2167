            ...
            <ul class="nav navbar-nav side-nav" id="sidebar">
              ...
              <li class="navigation" id="navigation">
                ...
                <ul class="menu">
                  ...
                  <li class="active">
                    <a href="index.jsp">
                      <i class="fa fa-tachometer"></i> 仪表板
                  ...
                  <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                      <i class="fa fa-list"></i> 形状 <b class="fa fa-plus dropdown-plus"></b>
                    </a>
                  ...
                  <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                      <i class="fa fa-pencil"></i> 界面 <b class="fa fa-plus dropdown-plus"></b>
                    </a>
                    <ul class="dropdown-menu">
                      <li>
                  ...
                  <li>
                    <a href="buttons.html">
                      <i class="fa fa-tint"></i> 按钮&图标
                    </a>
                  </li>
                  <li>
                    <a href="grid.html">
                      <i class="fa fa-th"></i> 网格布局
                    </a>
                  </li>

                  <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                      <i class="fa fa-th-large"></i> 统计分析表 <b class="fa fa-plus dropdown-plus"></b>
                    </a>
                    <ul class="dropdown-menu">
                      <li>
                        <a href="tables.html">
                  ...
                  <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                      <i class="fa fa-desktop"></i> 示例页 <b class="fa fa-plus dropdown-plus"></b>
                  ...
                  <li>
                    <a href="widgets.html">
                      <i class="fa fa-play-circle"></i> 窗口小部件
                    </a>
                  </li>
